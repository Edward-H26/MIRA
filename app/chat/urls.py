...
page_urlpatterns = [
    ...
    path("c/<int:session_id>/messages/<int:message_id>/edit/", views.message_edit_view, name="message_edit"),
    path("c/<int:session_id>/messages/<int:message_id>/resend/", views.message_resend_view, name="message_resend"),
