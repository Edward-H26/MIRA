...
page_urlpatterns = [
    ...
    path("agents/<str:agent_id>/files/<int:document_id>/delete/", views.agent_file_delete_view, name="agent_file_delete"),
    path("agents/<str:agent_id>/files/<int:document_id>/description/", views.agent_file_update_description_view, name="agent_file_update_description"),
    path("agents/<str:agent_id>/memory/", views.agent_memory_view, name="agent_memory"),
    path("memory/<int:bullet_id>/vote/", views.memory_vote_view, name="memory_vote"),
    ...
    path("groups/<int:session_id>/settings/", views.group_settings_view, name="group_settings"),
