...
This notebook implements a complete RAG pipeline that retrieves relevant context from a SEC 10-K annual filing and uses it to generate grounded answers via local language models. It evaluates 3 embedding models x 3 chunking strategies = 9 configurations across 8 test queries.
...
| `results/rag/experiment_results.json` | Raw experiment data (72 evaluations) |
...
- Qwen/Qwen3.5-0.8B (primary, 78.6% A7 accuracy)
- Qwen/Qwen3.5-2B (71.4% A7 accuracy)
- mistralai/Mistral-7B-Instruct-v0.2 (71.4% A7 accuracy)
